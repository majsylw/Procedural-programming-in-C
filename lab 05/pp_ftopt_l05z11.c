...
Zaimplementuj funkcje suma_tablicy(), która:
...
- dodaje do siebie wszystkie liczby mieszczace sie w tablicy i sprawdza czy dana suma jest podzielna przez dzielnik
- zwraca wynik w postaci 1 gdy suma jest podzielny, lub 0 gdy nie jest podzielna przez dzielnik
...
void testy(){
    ...
    if(suma_tablicy(tab1,3, 2) == 1){
        printf("1 -> pass\n\n");
    }
    else{
        printf("1 -> error!!!\n\n");
    }
    if(suma_tablicy(tab2,2, 2) == 1)
        printf("2 -> pass\n\n");
    else
        printf("2 -> error!!!\n \n");
    suma_tablicy(tab3,4, 5) == 0 ? printf("3 -> pass\n") : printf("3 -> error!!!\n");
}
