...
- int isgreaterPolynomial(struct Polynomial *, struct Polynomial *);
sprawdza czy pierwszy wielomian podany jako argument jest wiekszy od drugiego (drugi argument), tzn.
sprawdza czy stopien pierwszego wielomianu jest wiekszy od drugiego -> jesli tak to tu konczy prace,
jesli nie sprawdza po kolei czy wspolczynniki pierwszego wielomianu sa wieksze od wspolczynnikow drugiego idac od najwyzszej potegi
funkcja zwraca 1 w przypadku, gdy wielomiana pierwszy jest wiekszy od drugiego lub 0 gdy nie
