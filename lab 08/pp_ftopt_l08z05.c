...
- struct Polynomial substractPolynomial(struct Polynomial *, struct Polynomial *);
pozwala na wyliczenie roznicy dwoch wielomianow podanych jako argumenty (odejmujemy drugi od pierwszego),
zwracana jest struktura Polynomial bedaca roznica wielomianow
