...
- double returnvaluePolynomial(struct Polynomial *, double);
pozwala na wyliczenie (i zwrocenie) wartosci wielomianu dla podanego argumentu,
jako argument podajemy wskaznik na strukture oraz wartosc x dla ktorego chcemy wyliczyc wartosc wielomianu;
aby wyliczyc wartosc wielomianu w punkcie skorzystaj ze schematu Hornera
