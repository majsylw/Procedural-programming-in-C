...
sprawdza czy pierwszy wielomian podany jako argument jest rowny drugiemu (drugi argument), tzn.
sprawdza czy stopien pierwszego wielomianu jest rowny stopniowi drugiego wielomianu -> jesli nie to tu konczy prace,
jesli tak sprawdza po kolei czy wspolczynniki pierwszego wielomianu sa rowne wspolczynnikom drugiego;
