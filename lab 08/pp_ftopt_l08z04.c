...
- struct Polynomial derivPolynomial(struct Polynomial *);
pozwala na wyznaczenie postaci pochodnej z podanego wielomianu,
funkcja zwraca wielomian bedacy pochodna wielomianu podanego jako argument
(aby zaalokowac ponownie zmniejszona tablice wspolczynnikow skorzystaj z funkcji realloc:
