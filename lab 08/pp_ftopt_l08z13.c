...
- void setvaluePolynomial(struct Polynomial *, int, double);
pozwala na zmiane wartosci wybranego wspolczynnika, jako argument podajemy wskaznik na strukture, indeks tablicy (odpowiadajaca wspolczynnikowi potege) oraz nowa wartosc
