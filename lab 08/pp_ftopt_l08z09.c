...
- int issmallerPolynomial(struct Polynomial *, struct Polynomial *);
sprawdza czy pierwszy wielomian podany jako argument jest mniejszy od drugiego (drugi argument), tzn.
sprawdza czy stopien pierwszego wielomianu jest mniejszy od drugiego -> jesli tak to tu konczy prace,
jesli nie sprawdza po kolei czy wspolczynniki pierwszego wielomianu sa mniejsze od wspolczynnikow drugiego idac od najwyzszej potegi
funkcja zwraca 1 w przypadku, gdy wielomiana pierwszy jest mniejszy od drugiego lub 0 gdy nie
