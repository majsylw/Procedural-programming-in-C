...
- struct Polynomial substractPolynomial(struct Polynomial *, double);
pozwala na przemnożenie wszystkich wspolczynnikow wielomianu oraz liczby rzeczywistej podanych jako argumenty,
zwracana jest struktura Polynomial bedaca wynikiem przemnozenia wielomianu przez stala
