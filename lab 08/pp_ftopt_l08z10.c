...
- int getdegreePolynomial(struct Polynomial *);
pozwala na pokazanie stopnia konkretnego wielomianu,
zwracany jest stipien wielomianu, jako argument podajemy wskaznik na strukture Polynomial
