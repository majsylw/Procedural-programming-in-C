...
- double getvaluePolynomial(struct Polynomial *, int);
pozwala na odczytanie (zwrocenie) wartosci wybranego wspolczynnika, jako argument podajemy wskaznik na strukture oraz indeks tablicy (odpowiadajaca wspolczynnikowi potege)
