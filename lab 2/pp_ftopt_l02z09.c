...
Napisz funkcjê modulo(), która:
- pobiera od uzytkownika dwie liczby calkowite,
- wylicza ich reszte z dzielenia (zakladamy, ze dzielimy druga liczbe przez pierwsza, dla zadanej kolejnosci argumentow),
