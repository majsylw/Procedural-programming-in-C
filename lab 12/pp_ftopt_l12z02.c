...
Plik main.c:
W glownej funkci programu napisz program, ktory otworzy plik o nazwie 'pp_l12_dane_rfi2.dat'.
...
do pliku 'pp_l12_dane_xy.dat' stosujac precyzje zadana przez uzytkownika.
*/
